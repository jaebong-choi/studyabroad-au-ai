...
const DATA_EN = {
    ...
    "현재 학력 상태를 알려주세요.": "Where are you in your education right now?",
    "고교 내신 또는 수능 성적은 어느 정도이신가요?": "What are your school grades or CSAT score?",
    "고교 내신 성적은 어느 정도이신가요?": "What are your high school grades?",
    "수능 성적은 어느 정도이신가요?": "What is your CSAT score?",
    "호주 대학 상당수가 수능 성적을 정식 입학 자격으로 인정하고, 전공별 요구 점수를 공개하는 학교도 많습니다. 내신이 아쉬워도 수능으로 지원 가능한 경우가 있습니다.":
        "Many Australian universities accept the CSAT as a formal entry qualification, and a good number publish the score they require for each course. A strong CSAT can open doors that your school grades alone would not.",
    "고교 1~3등급 (상위권)": "School grades 1–3 (top band)",
    "고교 4~5등급 (중위권)": "School grades 4–5 (middle band)",
    "고교 6등급 이하 / 검정고시": "School grade 6 or below, or a GED",
    "수능 330점 이상 (상위권)": "CSAT 330 or above (top band)",
    "수능 300~330점": "CSAT 300–330",
    "수능 300점 미만": "CSAT below 300",
    "수능 미응시 / 성적 미반영": "Did not sit the CSAT, or not using it",
    ...
    "고등학교 재학 중 (졸업 예정)": "Still in high school (graduating soon)",
    "고등학교 졸업": "Finished high school",
    "대학교 재학/휴학/졸업": "At university, on leave, or graduated",
